...
@router.post("/{book_id}/reviews", response_model=ReviewResponse,dependencies=[Depends(get_current_user)])
...
@router.get("/{book_id}/reviews", response_model=List[ReviewResponse],dependencies=[Depends(get_current_user)])
